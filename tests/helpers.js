...
const CREATOR = { id: 'creator001', name: 'TestCreator', createdAt: '2026-01-01T00:00:00Z', phone: '6591234567' };
...
// Two confirmed timeslots — same group (unsent samples)
const CA_ROW_1 = {
  id: 'ca001',
  groupId: 'grp001',
...
// Third timeslot — different group — sample already sent
const CA_ROW_3 = {
  ...CA_ROW_1,
  id: 'ca003',
  groupId: 'grp002',
...
// Two pending rows — same group, status=pending (for creator apply tests)
...
// Two approved rows — same group (awaiting creator confirmation)
const CA_ROW_APPROVED_1 = { ...CA_ROW_PENDING_1, id: 'ca020', groupId: 'grp020', status: 'approved' };
const CA_ROW_APPROVED_2 = { ...CA_ROW_PENDING_2, id: 'ca021', groupId: 'grp020', status: 'approved' };

// Confirmed row — sample sent, awaiting creator receipt
const CA_ROW_SENT = {
  ...CA_ROW_1,
  id: 'ca005',
  streamDate: dateStr(28),
...
// Confirmed row — sample sent and received
